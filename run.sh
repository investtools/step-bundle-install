...
if [ -n "$WERCKER_BUNDLE_INSTALL_WORKING_DIR" ] ; then
    working_dir="$working_dir/$WERCKER_BUNDLE_INSTALL_WORKING_DIR"
fi
...
if [ ! -e "$working_dir" ]; then
    info "Skipping bundle install because Gemfile not found in $working_dir";
else
